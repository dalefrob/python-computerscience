# Lesson 6 - 
# Implementing a game win condition and fixing some bugs
...
checkpoints = [
   [(256, 0),(256, 128)],
   [(256, SCREENHEIGHT-128),(256, SCREENHEIGHT)],
   [(SCREENWIDTH-128, SCREENHEIGHT/2),(SCREENWIDTH, SCREENHEIGHT/2)],
]
...
while game_running == True:
  ...
  for chk in checkpoints:
     pygame.draw.line(screen, (255, 255, 0), chk[0], chk[1], 1)
